...
while True:
    ...
    client = MQTTClient("Pycom_Red", "io.adafruit.com", user="PFE_Pycom", password="aio_WoPB32roIJPXq6uKkwBlVHePiKiu", port=1883)
    client.connect()
    print("Connected")

    pycom.rgbled(0x000000)
    client.publish(topic="PFE_Pycom/feeds/pycoms",msg='Salle 1 : 11 C')
    client.check_msg() # regarder quels messages ont été envoyé
    print("Message envoye valeur | Salle 1 : 11 C")
